...
return (function (p__13169){
var vec__13170 = p__13169;
var attr = cljs.core.nth.call(null,vec__13170,(0),null);
...
var args13173 = [];
var len__8257__auto___13176 = arguments.length;
var i__8258__auto___13177 = (0);
while(true){
if((i__8258__auto___13177 < len__8257__auto___13176)){
args13173.push((arguments[i__8258__auto___13177]));

var G__13178 = (i__8258__auto___13177 + (1));
i__8258__auto___13177 = G__13178;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args13173.length)].join('')));
...
var len__8257__auto___13181 = arguments.length;
var i__8258__auto___13182 = (0);
while(true){
if((i__8258__auto___13182 < len__8257__auto___13181)){
args__8264__auto__.push((arguments[i__8258__auto___13182]));

var G__13183 = (i__8258__auto___13182 + (1));
i__8258__auto___13182 = G__13183;
continue;
} else {
}
break;
...
var argseq__8265__auto__ = ((((0) < args__8264__auto__.length))?(new cljs.core.IndexedSeq(args__8264__auto__.slice((0)),(0),null)):null);
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8265__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq13180){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13180));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__13184){
...
var data = map__13188__$1;
var message = cljs.core.get.call(null,map__13188__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__13188__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__13188__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__13190 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__13190,goog.events.EventType.CLICK,((function (G__13190,map__13188,map__13188__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__13190,map__13188,map__13188__$1,data,message,line,file))
);

return G__13190;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__13191){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__13198){
var map__13202 = p__13198;
...
var messages = map__13202__$1;
var warnings = cljs.core.get.call(null,map__13202__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13202__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__13204 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__13204,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__13204,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__13205){
...
var messages = map__13208__$1;
var warnings = cljs.core.get.call(null,map__13208__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13208__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__13208,map__13208__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__13208,map__13208__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__13208,map__13208__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__13208,map__13208__$1,messages,warnings,exception))
;
